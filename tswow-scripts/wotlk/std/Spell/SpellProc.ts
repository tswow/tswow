...
export enum SpellProcFlags {
    ...
    TAKEN_SPELL_MAGIC_DAMAGE_CLASS_POSITIVE = 0x8000,
    DONE_SPELL_MAGIC_DAMAGE_CLASS_NEGATIVE  = 0x10000,
    TAKEN_SPELL_MAGIC_DAMAGE_CLASS_NEGATIVE = 0x20000,
    DONE_PERIODIC                           = 0x40000,
    TAKEN_PERIODIC                          = 0x80000,
    TAKEN_DAMAGE                            = 0x100000,
    DONE_TRAP_ACTIVATION                    = 0x200000,
    DONE_MAINHAND_ATTACK                    = 0x400000,
    DONE_OFFHAND_ATTACK                     = 0x800000,
    DEATH                                   = 0x1000000
