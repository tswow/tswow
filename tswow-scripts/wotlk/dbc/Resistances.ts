...
import { DBCRow } from '../../data/dbc/DBCRow'
  ...
  */
export class ResistancesRow extends DBCRow<ResistancesCreator,ResistancesQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get FizzleSoundID() { return new DBCIntCell(this,this.buffer,this.offset+8)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class ResistancesDBCFile extends DBCFile<
    ResistancesCreator,
    ResistancesQuery,
    ResistancesRow> {
    constructor() {
