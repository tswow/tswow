...
import { DBCRow } from '../../data/dbc/DBCRow'
  ...
  */
export class GtChanceToSpellCritBaseRow extends DBCRow<GtChanceToSpellCritBaseCreator,GtChanceToSpellCritBaseQuery> {
    /**
     * No comment (yet!)
     */
 ...
 * - Add file comments to DBCFiles.ts
 */
export class GtChanceToSpellCritBaseDBCFile extends DBCFile<
