...
import { DBCRow } from '../../data/dbc/DBCRow'
  ...
  */
export class LoadingScreensRow extends DBCRow<LoadingScreensCreator,LoadingScreensQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get HasWideScreen() { return new DBCIntCell(this,this.buffer,this.offset+12)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class LoadingScreensDBCFile extends DBCFile<
