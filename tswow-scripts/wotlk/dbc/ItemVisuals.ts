...
import { DBCRow } from '../../data/dbc/DBCRow'
  ...
  */
export class ItemVisualsRow extends DBCRow<ItemVisualsCreator,ItemVisualsQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get Slot() { return new DBCIntArrayCell(this,5,this.buffer,this.offset+4)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class ItemVisualsDBCFile extends DBCFile<
    ItemVisualsCreator,
    ItemVisualsQuery,
    ItemVisualsRow> {
    constructor() {
