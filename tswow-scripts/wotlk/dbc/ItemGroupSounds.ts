...
import { DBCRow } from '../../data/dbc/DBCRow'
  ...
  */
export class ItemGroupSoundsRow extends DBCRow<ItemGroupSoundsCreator,ItemGroupSoundsQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get Sound() { return new DBCIntArrayCell(this,4,this.buffer,this.offset+4)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class ItemGroupSoundsDBCFile extends DBCFile<
