...
import { SqlTable } from '../../data/sql/SQLTable'
  ...
  */
export class disenchant_loot_templateRow extends SqlRow<disenchant_loot_templateCreator,disenchant_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     */
    clone(Entry : mediumint,Item : mediumint, c? : disenchant_loot_templateCreator) : this {
 ...
 */
export type disenchant_loot_templateCreator = {
    Entry? : mediumint,
    Item? : mediumint,
    Reference? : mediumint,
    Chance? : float,
 ...
 */
export type disenchant_loot_templateQuery = {
 ...
 */
export class disenchant_loot_templateTable extends SqlTable<
    disenchant_loot_templateCreator,
    disenchant_loot_templateQuery,
    disenchant_loot_templateRow> {
    add(Entry : mediumint,Item : mediumint, c? : disenchant_loot_templateCreator) : disenchant_loot_templateRow {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_disenchant_loot_template = new disenchant_loot_templateTable(
    'disenchant_loot_template',
    (table, obj)=>new disenchant_loot_templateRow(table, obj))