...
import { SqlTable } from '../../data/sql/SQLTable'
  ...
  */
export class pickpocketing_loot_templateRow extends SqlRow<pickpocketing_loot_templateCreator,pickpocketing_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export class pickpocketing_loot_templateTable extends SqlTable<
    pickpocketing_loot_templateCreator,
    pickpocketing_loot_templateQuery,
    pickpocketing_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_pickpocketing_loot_template = new pickpocketing_loot_templateTable(
    'pickpocketing_loot_template',
    (table, obj)=>new pickpocketing_loot_templateRow(table, obj))