...
import { SqlTable } from '../../data/sql/SQLTable'
  ...
  */
export class creature_loot_templateRow extends SqlRow<creature_loot_templateCreator,creature_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     */
    clone(Entry : mediumint,Item : mediumint, c? : creature_loot_templateCreator) : this {
 ...
 */
export type creature_loot_templateCreator = {
    Entry? : mediumint,
    Item? : mediumint,
    Reference? : mediumint,
    Chance? : float,
 ...
 */
export type creature_loot_templateQuery = {
 ...
 */
export class creature_loot_templateTable extends SqlTable<
    creature_loot_templateCreator,
    creature_loot_templateQuery,
    creature_loot_templateRow> {
    add(Entry : mediumint,Item : mediumint, c? : creature_loot_templateCreator) : creature_loot_templateRow {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_creature_loot_template = new creature_loot_templateTable(
    'creature_loot_template',
    (table, obj)=>new creature_loot_templateRow(table, obj))