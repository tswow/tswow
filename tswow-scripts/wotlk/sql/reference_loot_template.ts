...
import { SqlTable } from '../../data/sql/SQLTable'
  ...
  */
export class reference_loot_templateRow extends SqlRow<reference_loot_templateCreator,reference_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export class reference_loot_templateTable extends SqlTable<
    reference_loot_templateCreator,
    reference_loot_templateQuery,
    reference_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_reference_loot_template = new reference_loot_templateTable(
    'reference_loot_template',
    (table, obj)=>new reference_loot_templateRow(table, obj))