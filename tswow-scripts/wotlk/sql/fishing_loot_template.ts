...
import { SqlTable } from '../../data/sql/SQLTable'
  ...
  */
export class fishing_loot_templateRow extends SqlRow<fishing_loot_templateCreator,fishing_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export class fishing_loot_templateTable extends SqlTable<
    fishing_loot_templateCreator,
    fishing_loot_templateQuery,
    fishing_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_fishing_loot_template = new fishing_loot_templateTable(
    'fishing_loot_template',
    (table, obj)=>new fishing_loot_templateRow(table, obj))