        ...
        SQL.item_template
            ...
            .forEach(x=>{
                dbc.add(x.entry.get())
                    ...
                    .requiredhonorrank.set(x.requiredhonorrank.get())
                    ...
                    .stat_type2.set(x.stat_type1.get())
                    .stat_value2.set(x.stat_value1.get())
                    .stat_type3.set(x.stat_type1.get())
                    .stat_value3.set(x.stat_value1.get())
                    .stat_type4.set(x.stat_type1.get())
                    .stat_value4.set(x.stat_value1.get())
                    .stat_type5.set(x.stat_type1.get())
                    .stat_value5.set(x.stat_value1.get())
                    .stat_type6.set(x.stat_type1.get())
                    .stat_value6.set(x.stat_value1.get())
                    .stat_type7.set(x.stat_type1.get())
                    .stat_value7.set(x.stat_value1.get())
                    .stat_type8.set(x.stat_type1.get())
                    .stat_value8.set(x.stat_value1.get())
                    .stat_type9.set(x.stat_type1.get())
                    .stat_value9.set(x.stat_value1.get())
                    .stat_type10.set(x.stat_type1.get())
                    .stat_value10.set(x.stat_value1.get())
