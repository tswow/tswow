...
import { SqlTable } from '../SQLTable'
  ...
  */
export class player_factionchange_achievementRow extends SqlRow<player_factionchange_achievementCreator,player_factionchange_achievementQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export class player_factionchange_achievementTable extends SqlTable<
    player_factionchange_achievementCreator,
    player_factionchange_achievementQuery,
    player_factionchange_achievementRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_player_factionchange_achievement = new player_factionchange_achievementTable(
    'player_factionchange_achievement',
    (table, obj)=>new player_factionchange_achievementRow(table, obj))