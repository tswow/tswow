...
import { DBCRow } from '../DBCRow'
  ...
  */
export class GMTicketCategoryRow extends DBCRow<GMTicketCategoryCreator,GMTicketCategoryQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get Category() { return new DBCLocCell(this,this.buffer,this.offset+4)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class GMTicketCategoryDBCFile extends DBCFile<
