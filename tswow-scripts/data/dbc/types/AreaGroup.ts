...
import { DBCRow } from '../DBCRow'
  ...
  */
export class AreaGroupRow extends DBCRow<AreaGroupCreator,AreaGroupQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get AreaID() { return new DBCIntArrayCell(this,6,this.buffer,this.offset+4)}

    /**
     * No comment (yet!)
     */
    get NextAreaID() { return new DBCIntCell(this,this.buffer,this.offset+28)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class AreaGroupDBCFile extends DBCFile<
    AreaGroupCreator,
    AreaGroupQuery,
    AreaGroupRow> {
    constructor() {
