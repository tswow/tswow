...
import { DBCRow } from '../DBCRow'
  ...
  */
export class LanguageWordsRow extends DBCRow<LanguageWordsCreator,LanguageWordsQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get LanguageID() { return new DBCIntCell(this,this.buffer,this.offset+4)}

    /**
     * No comment (yet!)
     */
    get Word() { return new DBCStringCell(this,this.buffer,this.offset+8)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class LanguageWordsDBCFile extends DBCFile<
