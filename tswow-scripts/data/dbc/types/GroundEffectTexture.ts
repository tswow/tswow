...
import { DBCRow } from '../DBCRow'
  ...
  */
export class GroundEffectTextureRow extends DBCRow<GroundEffectTextureCreator,GroundEffectTextureQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 * - Add file comments to DBCFiles.ts
 */
export class GroundEffectTextureDBCFile extends DBCFile<
