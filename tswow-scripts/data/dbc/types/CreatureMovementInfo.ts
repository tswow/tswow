...
import { DBCFloatCell, DBCKeyCell } from '../DBCCell'
...
import { DBCRow } from '../DBCRow'
  ...
  */
export class CreatureMovementInfoRow extends DBCRow<CreatureMovementInfoCreator,CreatureMovementInfoQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get SmoothFacingChaseRate() { return new DBCFloatCell(this,this.buffer,this.offset+4)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class CreatureMovementInfoDBCFile extends DBCFile<
