...
import { DBCRow } from '../DBCRow'
  ...
  */
export class HelmetGeosetVisDataRow extends DBCRow<HelmetGeosetVisDataCreator,HelmetGeosetVisDataQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get HideGeoset() { return new DBCIntArrayCell(this,7,this.buffer,this.offset+4)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class HelmetGeosetVisDataDBCFile extends DBCFile<
