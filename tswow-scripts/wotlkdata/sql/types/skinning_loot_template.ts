...
import { SqlTable } from '../SQLTable'
  ...
  */
export class skinning_loot_templateRow extends SqlRow<skinning_loot_templateCreator,skinning_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     */
    clone(Entry : mediumint,Item : mediumint, c? : skinning_loot_templateCreator) : this {
 ...
 */
export type skinning_loot_templateCreator = {
    Entry? : mediumint,
    Item? : mediumint,
    Reference? : mediumint,
    Chance? : float,
 ...
 */
export type skinning_loot_templateQuery = {
 ...
 */
export class skinning_loot_templateTable extends SqlTable<
    skinning_loot_templateCreator,
    skinning_loot_templateQuery,
    skinning_loot_templateRow> {
    add(Entry : mediumint,Item : mediumint, c? : skinning_loot_templateCreator) : skinning_loot_templateRow {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_skinning_loot_template = new skinning_loot_templateTable(
    'skinning_loot_template',
    (table, obj)=>new skinning_loot_templateRow(table, obj))