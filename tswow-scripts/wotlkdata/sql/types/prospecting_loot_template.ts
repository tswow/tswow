...
import { SqlTable } from '../SQLTable'
  ...
  */
export class prospecting_loot_templateRow extends SqlRow<prospecting_loot_templateCreator,prospecting_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     */
    clone(Entry : mediumint,Item : mediumint, c? : prospecting_loot_templateCreator) : this {
 ...
 */
export type prospecting_loot_templateCreator = {
    Entry? : mediumint,
    Item? : mediumint,
    Reference? : mediumint,
    Chance? : float,
 ...
 */
export type prospecting_loot_templateQuery = {
 ...
 */
export class prospecting_loot_templateTable extends SqlTable<
    prospecting_loot_templateCreator,
    prospecting_loot_templateQuery,
    prospecting_loot_templateRow> {
    add(Entry : mediumint,Item : mediumint, c? : prospecting_loot_templateCreator) : prospecting_loot_templateRow {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_prospecting_loot_template = new prospecting_loot_templateTable(
    'prospecting_loot_template',
    (table, obj)=>new prospecting_loot_templateRow(table, obj))