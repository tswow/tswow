...
import { SqlTable } from '../SQLTable'
  ...
  */
export class quest_detailsRow extends SqlRow<quest_detailsCreator,quest_detailsQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export class quest_detailsTable extends SqlTable<
    quest_detailsCreator,
    quest_detailsQuery,
    quest_detailsRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_quest_details = new quest_detailsTable(
    'quest_details',
    (table, obj)=>new quest_detailsRow(table, obj))