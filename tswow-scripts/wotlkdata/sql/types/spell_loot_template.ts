...
import { SqlTable } from '../SQLTable'
  ...
  */
export class spell_loot_templateRow extends SqlRow<spell_loot_templateCreator,spell_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     */
    clone(Entry : mediumint,Item : mediumint, c? : spell_loot_templateCreator) : this {
 ...
 */
export type spell_loot_templateCreator = {
    Entry? : mediumint,
    Item? : mediumint,
    Reference? : mediumint,
    Chance? : float,
 ...
 */
export type spell_loot_templateQuery = {
 ...
 */
export class spell_loot_templateTable extends SqlTable<
    spell_loot_templateCreator,
    spell_loot_templateQuery,
    spell_loot_templateRow> {
    add(Entry : mediumint,Item : mediumint, c? : spell_loot_templateCreator) : spell_loot_templateRow {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_spell_loot_template = new spell_loot_templateTable(
    'spell_loot_template',
    (table, obj)=>new spell_loot_templateRow(table, obj))