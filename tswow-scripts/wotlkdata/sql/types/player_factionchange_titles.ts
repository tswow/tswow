...
import { SqlTable } from '../SQLTable'
  ...
  */
export class player_factionchange_titlesRow extends SqlRow<player_factionchange_titlesCreator,player_factionchange_titlesQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export class player_factionchange_titlesTable extends SqlTable<
    player_factionchange_titlesCreator,
    player_factionchange_titlesQuery,
    player_factionchange_titlesRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_player_factionchange_titles = new player_factionchange_titlesTable(
    'player_factionchange_titles',
    (table, obj)=>new player_factionchange_titlesRow(table, obj))