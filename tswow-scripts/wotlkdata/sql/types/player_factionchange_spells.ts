...
import { SqlTable } from '../SQLTable'
  ...
  */
export class player_factionchange_spellsRow extends SqlRow<player_factionchange_spellsCreator,player_factionchange_spellsQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export class player_factionchange_spellsTable extends SqlTable<
    player_factionchange_spellsCreator,
    player_factionchange_spellsQuery,
    player_factionchange_spellsRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_player_factionchange_spells = new player_factionchange_spellsTable(
    'player_factionchange_spells',
    (table, obj)=>new player_factionchange_spellsRow(table, obj))