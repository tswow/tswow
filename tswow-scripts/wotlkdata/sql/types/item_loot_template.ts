...
import { SqlTable } from '../SQLTable'
  ...
  */
export class item_loot_templateRow extends SqlRow<item_loot_templateCreator,item_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     */
    clone(Entry : mediumint,Item : mediumint, c? : item_loot_templateCreator) : this {
 ...
 */
export type item_loot_templateCreator = {
    Entry? : mediumint,
    Item? : mediumint,
    Reference? : mediumint,
    Chance? : float,
 ...
 */
export type item_loot_templateQuery = {
 ...
 */
export class item_loot_templateTable extends SqlTable<
    item_loot_templateCreator,
    item_loot_templateQuery,
    item_loot_templateRow> {
    add(Entry : mediumint,Item : mediumint, c? : item_loot_templateCreator) : item_loot_templateRow {
 ...
 * - Add file comments to SQLFiles.ts
 */
export const SQL_item_loot_template = new item_loot_templateTable(
    'item_loot_template',
    (table, obj)=>new item_loot_templateRow(table, obj))