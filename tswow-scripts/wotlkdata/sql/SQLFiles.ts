...
export const SQL = {
    /**
     * Reads a value from the source world database.
     * @param query 
     * @returns Query result
     */
    Read: function(query: string) {
        return SqlConnection.querySource(query);
    },

    /**
     * Writes a query to the destination database.
     * 
     * Will be stored and written once all script files have been applied.
     * 
     * @param query 
     */
    Write: function(query: string) {
        SqlConnection.addWriteQuery(query);
    },
