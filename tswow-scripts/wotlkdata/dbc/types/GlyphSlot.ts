...
import { DBCRow } from '../DBCRow'
  ...
  */
export class GlyphSlotRow extends DBCRow<GlyphSlotCreator,GlyphSlotQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
     ...
     * No comment (yet!)
     */
    get Tooltip() { return new DBCIntCell(this,this.buffer,this.offset+8)}
 ...
 * - Add file comments to DBCFiles.ts
 */
export class GlyphSlotDBCFile extends DBCFile<
    GlyphSlotCreator,
    GlyphSlotQuery,
    GlyphSlotRow> {
    constructor() {
