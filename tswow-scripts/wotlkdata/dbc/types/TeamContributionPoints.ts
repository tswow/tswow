...
import { DBCRow } from '../DBCRow'
  ...
  */
export class TeamContributionPointsRow extends DBCRow<TeamContributionPointsCreator,TeamContributionPointsQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 * - Add file comments to DBCFiles.ts
 */
export class TeamContributionPointsDBCFile extends DBCFile<
