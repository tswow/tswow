    ...
    , roles: {class:number,tank:number,healer:number,damage:number,leader:number}[]
        ...
        return [
            ...
            /*patch('additional-sections', [
                ...
                //
                [0x2F8, [
                    0x2E, 0x63, 0x74, 0x65, 0x78, 0x74, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0xD0, 0x9F, 0x00,
                    0x00, 0x0E, 0x00, 0x00, 0x00, 0x7C, 0x75
                ]],
                [0x31C, [
                    0x20, 0x00, 0x00, 0x60, 0x2E, 0x63, 0x64, 0x61, 0x74, 0x61, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,
                    0x00, 0xE0, 0x9F, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x8A, 0x75
                ]],
                [0x344, [
                    0x40, 0x00, 0x00, 0x40, 0x2E, 0x64, 0x64, 0x61, 0x74, 0x61, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
                    0x00, 0xF0, 0x9F, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x8C, 0x75
                ]],
                [0x36C, [0x40, 0x00, 0x00, 0xC0]]
            ]),*/
        ]
}
