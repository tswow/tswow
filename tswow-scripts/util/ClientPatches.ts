    ...
    , roles: {class:number,tank:number,healer:number,damage:number,leader:number}[]
        ...
        return [
            ...
            patch('class roles',[
                ...
                // xrefs
                [0x151d48,[0x37,0x32,0x9E,0x00]],   // 0x552948
                [0x152f7d,[0x37,0x32,0x9E,0x00]],   // 0x553B7D
                [0x152f94,[0x37,0x32,0x9E,0x00]],   // 0x553B94
                [0x1531e7,[0x37,0x32,0x9E,0x00]],   // 0x553DE7
                [0x153d22,[0x37,0x32,0x9E,0x00]],   // 0x554922
            ]),
