...
std.Spells.create(/*@1*/"mod"/**/,/*@2*/"id"/**/)
    ...
    .TargetType.UnitEnemy.set(true)
    .PowerDisplay.setNone()
    .SchoolMask.Arcane.set(true)
    .SchoolMask.Fire.set(true)
    .Range.setSimple(0,1000)
    .Power.setMana(100)
...
std.Spells.create(/*@1*/"mod"/**/,/*@2*/"id"/**/)
    .Attributes.notShapeshifted.set(true)
    .Attributes.dismissPet.set(true)
