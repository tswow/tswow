...
void TSItemTemplate::Save()
{
    ...
    stmt->setUInt32(108, info->Material);
    stmt->setUInt32(109, info->Sheath);
    stmt->setUInt32(110, info->RandomProperty);
    stmt->setUInt32(111, info->RandomSuffix);
    ...
    stmt->setInt32(127, info->RequiredDisenchantSkill);
    stmt->setUInt32(128, info->ArmorDamageModifier);
