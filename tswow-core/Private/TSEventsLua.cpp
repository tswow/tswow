...
void TSLua::load_events(sol::state& state)
{
    ...
    LUA_HANDLE(player_events, PlayerEvents, OnCheckAreaIsPvP);
    ...
    LUA_MAPPED_HANDLE(instance_events, InstanceEvents, OnDataSet);
    LUA_MAPPED_HANDLE(instance_events, InstanceEvents, OnDataGet);
