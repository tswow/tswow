...
public:
    ...
    uint32 GetItemSet();
    void GetItemSet(uint32 value);
    uint32 GetMaxDurability();
    void GetMaxDurability(uint32 value);
    uint32 GetArea();
    void GetArea(uint32 value);
    uint32 GetMap();
    void GetMap(uint32 value);
    uint32 GetBagFamily();
    void GetBagFamily(uint32 value);
    uint32 GetTotemCategory();
    void GetTotemCategory(uint32 value);
    ...
    void GetMinMoneyLoot(uint32 value);
