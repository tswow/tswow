...
EVENT_TYPE(PlayerOnTalentsResetEarly, TSPlayer, TSMutable<bool>)
EVENT_TYPE(PlayerOnTalentsReset, TSPlayer, bool)
EVENT_TYPE(PlayerOnTalentsResetLate, TSPlayer, bool /*noCost*/)
...
EVENT_TYPE(SpellOnSuccessfulDispel,TSSpell,uint32)
...
EVENT_TYPE(SpellOnCheckAreaTarget, TSAura, TSUnit, TSMutable<bool> /*result*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnCheckEffectProc, TSAuraEffect, TSAuraApplication, TSProcEventInfo, TSMutable<bool> /*result*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnCheckProc, TSAuraApplication, TSProcEventInfo, TSMutable<bool> /*result*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectPeriodic, TSAuraEffect, TSAuraApplication, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectProc, TSAuraEffect, TSAuraApplication, TSProcEventInfo, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnPrepareProc, TSAuraApplication, TSProcEventInfo, TSMutable<bool> /*prepare*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnProc, TSAuraApplication, TSProcEventInfo, TSMutable<bool> /*handled*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnAfterDispel, TSAura, TSDispelInfo, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnAfterEffectApply, TSAuraEffect, TSAuraApplication, uint32 /*modes*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnAfterEffectProc, TSAuraEffect, TSAuraApplication, TSProcEventInfo, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnAfterEffectRemove, TSAuraEffect, TSAuraApplication, uint32 /*modes*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnAfterProc, TSAuraApplication, TSProcEventInfo, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnDispel, TSAura, TSDispelInfo, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectAbsorb, TSAuraEffect, TSAuraApplication, TSDamageInfo, TSMutable<uint32> /*absorbAmount*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectAfterAbsorb, TSAuraEffect, TSAuraApplication, TSDamageInfo, TSMutable<uint32> /*absorbAmount*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectAfterManaShield, TSAuraEffect, TSAuraApplication, TSDamageInfo, TSMutable<uint32> /*absorbAmount*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectCalcAmount, TSAuraEffect, TSMutable<int32> /*amount*/, TSMutable<bool> /*canBeRecalculated*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectCalcPeriodic, TSAuraEffect, TSMutable<bool> /*isPeriodic*/, TSMutable<int32> /*amplitude*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectCalcSpellMod, TSAuraEffect, TSSpellModifier, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectManaShield, TSAuraEffect, TSAuraApplication, TSDamageInfo, TSMutable<uint32> /*absorbAmount*/, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnEffectSplit, TSAuraEffect, TSAuraApplication, TSDamageInfo, TSMutable<uint32> /*splitAmount*/, TSMutable<bool> /*cancelDefault*/)

EVENT_TYPE(SpellOnAfterCast, TSSpell, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnAfterHit, TSSpell, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnBeforeCast, TSSpell, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnBeforeHit, TSSpell, uint32, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnDestinationTargetSelect, TSSpell, TSSpellDestination, uint32 /*index*/, TSSpellImplicitTargetInfo, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnObjectAreaTargetSelect, TSSpell, TSWorldObjectCollection , uint32 /*index*/, TSSpellImplicitTargetInfo, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnObjectTargetSelect, TSSpell, TSMutableWorldObject, uint32 /*index*/, TSSpellImplicitTargetInfo, TSMutable<bool> /*cancelDefault*/)
EVENT_TYPE(SpellOnOnResistAbsorbCalculate, TSSpell, TSDamageInfo, TSMutable<uint32> /*resistAmount*/, TSMutable<int32> /*absorbAmount*/, TSMutable<bool> /*cancelDefault*/)

struct TSSpellEvents {
     EVENT(SpellOnCast)
     EVENT(SpellOnCheckCast)
     EVENT(SpellOnSuccessfulDispel)
     EVENT(SpellOnEffect)
     ...
     EVENT(SpellOnCheckAreaTarget)
     EVENT(SpellOnCheckEffectProc)
     EVENT(SpellOnCheckProc)
     EVENT(SpellOnEffectPeriodic)
     EVENT(SpellOnEffectProc)
     EVENT(SpellOnPrepareProc)
     EVENT(SpellOnProc)
     EVENT(SpellOnAfterDispel)
     EVENT(SpellOnAfterEffectApply)
     EVENT(SpellOnAfterEffectProc)
     EVENT(SpellOnAfterEffectRemove)
     EVENT(SpellOnAfterProc)
     EVENT(SpellOnDispel)
     EVENT(SpellOnEffectAbsorb)
     EVENT(SpellOnEffectAfterAbsorb)
     EVENT(SpellOnEffectAfterManaShield)
     EVENT(SpellOnEffectCalcAmount)
     EVENT(SpellOnEffectCalcPeriodic)
     EVENT(SpellOnEffectCalcSpellMod)
     EVENT(SpellOnEffectManaShield)
     EVENT(SpellOnEffectSplit)
     EVENT(SpellOnAfterCast)
     EVENT(SpellOnAfterHit)
     EVENT(SpellOnBeforeCast)
     EVENT(SpellOnBeforeHit)
     EVENT(SpellOnDestinationTargetSelect)
     EVENT(SpellOnObjectAreaTargetSelect)
     EVENT(SpellOnObjectTargetSelect)
     EVENT(SpellOnOnResistAbsorbCalculate)
};
...
struct TSEventStore
{
    ...
    EVENT(PlayerOnTalentsResetEarly)
    EVENT(PlayerOnTalentsReset)
    EVENT(PlayerOnTalentsResetLate)
...
public:
    ...
    struct PlayerEvents : public EventHandler
    {
         ...
         EVENT_HANDLE(Player,OnTalentsResetEarly)
         EVENT_HANDLE(Player,OnTalentsReset)
         EVENT_HANDLE(Player,OnTalentsResetLate)
     ...
     struct SpellEvents : public EventHandler
    {
          ...
          EVENT_HANDLE(Spell,OnSuccessfulDispel)
          ...
          EVENT_HANDLE(Spell,OnCheckAreaTarget)
          EVENT_HANDLE(Spell,OnCheckEffectProc)
          EVENT_HANDLE(Spell,OnCheckProc)
          EVENT_HANDLE(Spell,OnEffectPeriodic)
          EVENT_HANDLE(Spell,OnEffectProc)
          EVENT_HANDLE(Spell,OnPrepareProc)
          EVENT_HANDLE(Spell,OnProc)
          EVENT_HANDLE(Spell,OnAfterDispel)
          EVENT_HANDLE(Spell,OnAfterEffectApply)
          EVENT_HANDLE(Spell,OnAfterEffectProc)
          EVENT_HANDLE(Spell,OnAfterEffectRemove)
          EVENT_HANDLE(Spell,OnAfterProc)
          EVENT_HANDLE(Spell,OnDispel)
          EVENT_HANDLE(Spell,OnEffectAbsorb)
          EVENT_HANDLE(Spell,OnEffectAfterAbsorb)
          EVENT_HANDLE(Spell,OnEffectAfterManaShield)
          EVENT_HANDLE(Spell,OnEffectCalcAmount)
          EVENT_HANDLE(Spell,OnEffectCalcPeriodic)
          EVENT_HANDLE(Spell,OnEffectCalcSpellMod)
          EVENT_HANDLE(Spell,OnEffectManaShield)
          EVENT_HANDLE(Spell,OnEffectSplit)
          EVENT_HANDLE(Spell,OnAfterCast)
          EVENT_HANDLE(Spell,OnAfterHit)
          EVENT_HANDLE(Spell,OnBeforeCast)
          EVENT_HANDLE(Spell,OnBeforeHit)
          EVENT_HANDLE(Spell,OnDestinationTargetSelect)
          EVENT_HANDLE(Spell,OnObjectAreaTargetSelect)
          EVENT_HANDLE(Spell,OnObjectTargetSelect)
          EVENT_HANDLE(Spell,OnOnResistAbsorbCalculate)
    } Spells;
    ...
    struct SpellIDEvents : public MappedEventHandler<TSSpellMap>
    {
          ...
          MAP_EVENT_HANDLE(Spell,OnSuccessfulDispel)
          ...
          MAP_EVENT_HANDLE(Spell, OnCheckAreaTarget)
          MAP_EVENT_HANDLE(Spell, OnCheckEffectProc)
          MAP_EVENT_HANDLE(Spell, OnCheckProc)
          MAP_EVENT_HANDLE(Spell, OnEffectPeriodic)
          MAP_EVENT_HANDLE(Spell, OnEffectProc)
          MAP_EVENT_HANDLE(Spell, OnPrepareProc)
          MAP_EVENT_HANDLE(Spell, OnProc)
          MAP_EVENT_HANDLE(Spell, OnAfterDispel)
          MAP_EVENT_HANDLE(Spell, OnAfterEffectApply)
          MAP_EVENT_HANDLE(Spell, OnAfterEffectProc)
          MAP_EVENT_HANDLE(Spell, OnAfterEffectRemove)
          MAP_EVENT_HANDLE(Spell, OnAfterProc)
          MAP_EVENT_HANDLE(Spell, OnDispel)
          MAP_EVENT_HANDLE(Spell, OnEffectAbsorb)
          MAP_EVENT_HANDLE(Spell, OnEffectAfterAbsorb)
          MAP_EVENT_HANDLE(Spell, OnEffectAfterManaShield)
          MAP_EVENT_HANDLE(Spell, OnEffectCalcAmount)
          MAP_EVENT_HANDLE(Spell, OnEffectCalcPeriodic)
          MAP_EVENT_HANDLE(Spell, OnEffectCalcSpellMod)
          MAP_EVENT_HANDLE(Spell, OnEffectManaShield)
          MAP_EVENT_HANDLE(Spell, OnEffectSplit)
          MAP_EVENT_HANDLE(Spell, OnAfterCast)
          MAP_EVENT_HANDLE(Spell, OnAfterHit)
          MAP_EVENT_HANDLE(Spell, OnBeforeCast)
          MAP_EVENT_HANDLE(Spell, OnBeforeHit)
          MAP_EVENT_HANDLE(Spell, OnDestinationTargetSelect)
          MAP_EVENT_HANDLE(Spell, OnObjectAreaTargetSelect)
          MAP_EVENT_HANDLE(Spell, OnObjectTargetSelect)
          MAP_EVENT_HANDLE(Spell, OnOnResistAbsorbCalculate)
    } SpellID;
