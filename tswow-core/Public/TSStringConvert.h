...
TC_GAME_API double parseInt(std::string const& str);
TC_GAME_API double parseFloat(std::string const& str);
TC_GAME_API uint8 ToUInt8(std::string const& value);
TC_GAME_API int8 ToInt8(std::string const& value);
TC_GAME_API uint16 ToUInt16(std::string const& value);
TC_GAME_API int16 ToInt16(std::string const& value);
TC_GAME_API uint32 ToUInt32(std::string const& value);
TC_GAME_API int32 ToInt32(std::string const& value);
TC_GAME_API uint64 ToUInt64(std::string const& value);
TC_GAME_API int64 ToInt64(std::string const& value);
TC_GAME_API double ToDouble(std::string const& value);
TC_GAME_API float ToFloat(std::string const& value);
