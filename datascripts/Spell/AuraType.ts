...
export class AuraType extends Enum<SpellEffect<any>> {
    constructor(owner: SpellEffect<any>, effectIndex: number) {
    ...
    /** */
    @EnumField(1)
    setBindSight() { return new BindSight(this.end.end, this.set(1));  };
    /** */
    @EnumField(2)
