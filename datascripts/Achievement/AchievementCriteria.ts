import { EnumCellWrapperTransform, TransformedClass } from "wotlkdata/cell/cells/EnumCell";
...
export class CriteriaBase extends TransformedClass<CriteriaPlain> {
    transformer(): EnumCellWrapperTransform<this> {
        return this.Type;
    }

    default() { return new CriteriaPlain(this.row); }

    @Transient
    readonly row: Achievement_CriteriaRow
...
export class CriteriaType<T extends CriteriaBase> extends EnumCellWrapperTransform<T> {
