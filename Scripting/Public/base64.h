...
unsigned encodeBase64(uint8_t* in, unsigned in_length, uint8_t* out)
{
    ...
    uint8_t* outEnd = out;
    outEnd += cbase64_encode_block((const unsigned char*)in, in_length, (char*)outEnd, &encodeState);
    outEnd += cbase64_encode_blockend((char*)outEnd, &encodeState);
    return outEnd - out;
}
...
unsigned decodeBase64(uint8_t* in, unsigned in_length, uint8_t* out)
{
    ...
    uint8_t* outEnd = out;
    outEnd += cbase64_decode_block((const char*)in, in_length, (unsigned char*)outEnd, &decodeState);
    return outEnd - out;
}
