...
namespace ClientLua {
    ...
    CLIENT_FUNC(DoString, 0x00819210, __cdecl, void, (char const* code, lua_State* L))
    CLIENT_FUNC(GetTop, 0x0084DBD0, __cdecl, int, (lua_State* L))

    CLIENT_FUNC(IsString, 0x0084DF60, __cdecl, uint32_t, (lua_State* L, int32_t))
    CLIENT_FUNC(IsNumber, 0x0084DF20, __cdecl, int32_t, (lua_State* L, int32_t))

    CLIENT_FUNC(PushNumber, 0x0084E2A0, __cdecl, int, (lua_State* L, double value))
    CLIENT_FUNC(PushString, 0x0084E350, __cdecl, int, (lua_State* L, char const* value))
