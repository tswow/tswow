 ...
 */
export declare abstract class DBCSQLRegistryBase<DBC extends Row<any, DBCQuery> & {
    clone: (id: number) => DBC;
}, SQL extends Row<any, SQLQuery> & {
    clone: (id: number) => SQL;
}, DBCQuery, SQLQuery, E extends TwoRowMainEntity<DBC, SQL>> extends RegistryBase<E, DBCQuery> {
    ...
    getAll(): E[];
    queryAllDBC(query: DBCQuery): E[];
    queryDBC(query: DBCQuery): E;
    queryAllSQL(query: SQLQuery): E[];
    querySQL(query: SQLQuery): E;
}
/**
 * Registry for entities defined in both DBC and SQL
 *
 */
export declare abstract class DBCSQLRegistryStatic<DBC extends Row<any, DBCQuery> & {
    clone: (id: number) => DBC;
}, SQL extends Row<any, SQLQuery> & {
    clone: (id: number) => SQL;
}, DBCQuery, SQLQuery, E extends TwoRowMainEntity<DBC, SQL>> extends DBCSQLRegistryBase<DBC, SQL, DBCQuery, SQLQuery, E> {
    protected abstract DBCTable(): Table<any, DBCQuery, DBC> & {
        add: (id: number) => DBC;
    };
    protected abstract SQLTable(): Table<any, SQLQuery, SQL> & {
