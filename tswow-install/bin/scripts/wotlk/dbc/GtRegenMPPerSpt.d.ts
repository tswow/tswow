 ...
 */
export declare class GtRegenMPPerSptRow extends DBCRow<GtRegenMPPerSptCreator, GtRegenMPPerSptQuery> {
    /**
     * No comment (yet!)
     */
 ...
 * - Add file comments to DBCFiles.ts
 */
export declare class GtRegenMPPerSptDBCFile extends DBCFile<GtRegenMPPerSptCreator, GtRegenMPPerSptQuery, GtRegenMPPerSptRow> {
    constructor();
