 ...
 */
export declare class ItemBagFamilyRow extends DBCRow<ItemBagFamilyCreator, ItemBagFamilyQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 * - Add file comments to DBCFiles.ts
 */
export declare class ItemBagFamilyDBCFile extends DBCFile<ItemBagFamilyCreator, ItemBagFamilyQuery, ItemBagFamilyRow> {
    constructor();
    ...
    findById(id: number): ItemBagFamilyRow;
}
