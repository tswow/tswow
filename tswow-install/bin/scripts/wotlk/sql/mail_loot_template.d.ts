 ...
 */
export declare class mail_loot_templateRow extends SqlRow<mail_loot_templateCreator, mail_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class mail_loot_templateTable extends SqlTable<mail_loot_templateCreator, mail_loot_templateQuery, mail_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_mail_loot_template: mail_loot_templateTable;
