 ...
 */
export declare class creature_loot_templateRow extends SqlRow<creature_loot_templateCreator, creature_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class creature_loot_templateTable extends SqlTable<creature_loot_templateCreator, creature_loot_templateQuery, creature_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_creature_loot_template: creature_loot_templateTable;
