 ...
 */
export declare class item_loot_templateRow extends SqlRow<item_loot_templateCreator, item_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class item_loot_templateTable extends SqlTable<item_loot_templateCreator, item_loot_templateQuery, item_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_item_loot_template: item_loot_templateTable;
