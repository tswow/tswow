 ...
 */
export declare class player_factionchange_questsRow extends SqlRow<player_factionchange_questsCreator, player_factionchange_questsQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class player_factionchange_questsTable extends SqlTable<player_factionchange_questsCreator, player_factionchange_questsQuery, player_factionchange_questsRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_player_factionchange_quests: player_factionchange_questsTable;
