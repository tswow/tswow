 ...
 */
export declare class disenchant_loot_templateRow extends SqlRow<disenchant_loot_templateCreator, disenchant_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class disenchant_loot_templateTable extends SqlTable<disenchant_loot_templateCreator, disenchant_loot_templateQuery, disenchant_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_disenchant_loot_template: disenchant_loot_templateTable;
