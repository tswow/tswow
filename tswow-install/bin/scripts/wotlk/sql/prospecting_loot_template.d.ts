 ...
 */
export declare class prospecting_loot_templateRow extends SqlRow<prospecting_loot_templateCreator, prospecting_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class prospecting_loot_templateTable extends SqlTable<prospecting_loot_templateCreator, prospecting_loot_templateQuery, prospecting_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_prospecting_loot_template: prospecting_loot_templateTable;
