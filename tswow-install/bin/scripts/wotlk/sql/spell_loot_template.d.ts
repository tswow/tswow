 ...
 */
export declare class spell_loot_templateRow extends SqlRow<spell_loot_templateCreator, spell_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class spell_loot_templateTable extends SqlTable<spell_loot_templateCreator, spell_loot_templateQuery, spell_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_spell_loot_template: spell_loot_templateTable;
