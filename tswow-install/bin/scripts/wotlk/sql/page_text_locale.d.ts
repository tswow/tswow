 ...
 */
export declare class page_text_localeRow extends SqlRow<page_text_localeCreator, page_text_localeQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class page_text_localeTable extends SqlTable<page_text_localeCreator, page_text_localeQuery, page_text_localeRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_page_text_locale: page_text_localeTable;
