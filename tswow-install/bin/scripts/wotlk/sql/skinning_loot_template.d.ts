 ...
 */
export declare class skinning_loot_templateRow extends SqlRow<skinning_loot_templateCreator, skinning_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class skinning_loot_templateTable extends SqlTable<skinning_loot_templateCreator, skinning_loot_templateQuery, skinning_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_skinning_loot_template: skinning_loot_templateTable;
