 ...
 */
export declare class battleground_door_objectRow extends SqlRow<battleground_door_objectCreator, battleground_door_objectQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class battleground_door_objectTable extends SqlTable<battleground_door_objectCreator, battleground_door_objectQuery, battleground_door_objectRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_battleground_door_object: battleground_door_objectTable;
