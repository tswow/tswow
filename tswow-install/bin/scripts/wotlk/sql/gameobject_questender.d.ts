 ...
 */
export declare class gameobject_questenderRow extends SqlRow<gameobject_questenderCreator, gameobject_questenderQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class gameobject_questenderTable extends SqlTable<gameobject_questenderCreator, gameobject_questenderQuery, gameobject_questenderRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_gameobject_questender: gameobject_questenderTable;
