 ...
 */
export declare class gameobject_loot_templateRow extends SqlRow<gameobject_loot_templateCreator, gameobject_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class gameobject_loot_templateTable extends SqlTable<gameobject_loot_templateCreator, gameobject_loot_templateQuery, gameobject_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_gameobject_loot_template: gameobject_loot_templateTable;
