 ...
 */
export declare class milling_loot_templateRow extends SqlRow<milling_loot_templateCreator, milling_loot_templateQuery> {
    /**
     * Primary Key
     *
     * No comment (yet!)
 ...
 */
export declare class milling_loot_templateTable extends SqlTable<milling_loot_templateCreator, milling_loot_templateQuery, milling_loot_templateRow> {
 ...
 * - Add file comments to SQLFiles.ts
 */
export declare const SQL_milling_loot_template: milling_loot_templateTable;
